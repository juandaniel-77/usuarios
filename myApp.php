...
try
{
	$newId = $account->addAccount('juandsan@gmail.com', 'juandaniel');
}
catch (Exception $e)
{
	echo $e->getMessage();
...
try
{
	$account->editAccount($accountId, 'myNe', 'new password', TRUE);
}
catch (Exception $e)
{
	echo $e->getMessage();
...
try
{
	$login = $account->login('juandsan@gmail.com', 'juandaniel');
}
catch (Exception $e)
{
	echo $e->getMessage();
...
/* try
{
	$login = $account->login('juandaniel', 'juandaniel');
