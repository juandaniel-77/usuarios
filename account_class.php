...
class Account
{
	...
	public function addAccount(string $name, string $passwd): int
	{
		...
		catch (PDOException $e)
		{
		   ...
		   throw new Exception('Database query error'.$query);
		}
	...
	public function deleteAccount(int $id)
	{
		...
		{
		   /* If there is a PDO exception, throw a standard exception */
		   throw new Exception('Database query error delete');
		}
	...
	public function login(string $name, string $passwd): bool
	{
		...
		{
		   /* If there is a PDO exception, throw a standard exception */
		   throw new Exception('Database query error 3');
		}
	...
	public function getIdFromName(string $name): ?int
	{
		...
		$query = 'SELECT account_id FROM usuarios.accounts WHERE (account_name = :name OR oauth_uid = :name)';
		$values = array(':name' => $name);
		...
		{
		   /* If there is a PDO exception, throw a standard exception */
		   throw new Exception('Database query error  7');
		}
	...
	private function registerLoginSession()
	{
		...
		if (session_status() == PHP_SESSION_ACTIVE)
		{
			...
			*/
			...
			{
			   /* If there is a PDO exception, throw a standard exception */
			   throw new Exception('Database query error 8');
			}
		}
	}
}
